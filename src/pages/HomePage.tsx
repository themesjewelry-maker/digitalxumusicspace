...
function SectionLabel({ text }: { text: string }) {
  return (
    <motion.span
      variants={fadeInUp}
      className="inline-block text-xs font-semibold tracking-[0.2em] uppercase text-[#86868B] mb-4"
    >
      {text}
    </motion.span>
  );
...
function SectionTitle({
  ...
  return (
    <motion.h2
      variants={fadeInUp}
      className={`text-3xl sm:text-4xl md:text-5xl lg:text-[56px] font-semibold tracking-tight text-[#1D1D1F] leading-[1.1] ${className}`}
    >
      {children}
    </motion.h2>
  );
...
function SectionDesc({
  ...
  return (
    <motion.p
      variants={fadeInUp}
      className={`text-base sm:text-lg md:text-xl text-[#86868B] leading-relaxed max-w-2xl ${className}`}
    >
      {children}
    </motion.p>
  );
      ...
      <div className="max-w-[1200px] mx-auto px-6 sm:px-8">
        <div className="text-center mb-16 sm:mb-20">
          ...
          <motion.div variants={fadeInUp} className="mt-8">
            <Link
              to="/philosophy"
              className="inline-flex items-center gap-2 text-sm text-[#1D1D1F] hover:text-[#86868B] transition-colors tracking-wide font-medium"
            >
              琴鸣教育理念
        ...
        >
          {values.map((item) => (
            <motion.div
              ...
              className="group text-center sm:text-left p-6 sm:p-8 rounded-2xl hover:bg-[#F5F5F7] transition-colors duration-500"
            >
              <div className="inline-flex items-center justify-center w-12 h-12 rounded-xl bg-[#1D1D1F] text-white mb-5 group-hover:scale-110 transition-transform duration-500">
                {item.icon}
              </div>
...
function CourseCard({
  ...
  return (
    ...
    >
      ...
      <motion.div
        variants={scaleIn}
        className="w-full lg:w-1/2 aspect-[4/3] sm:aspect-[16/10] rounded-2xl sm:rounded-3xl overflow-hidden bg-[#F5F5F7]"
      >
        <img
          src={imageUrl}
          alt={title}
        ...
        <motion.ul variants={staggerContainer} className="space-y-3 sm:space-y-4">
          {features.map((feature) => (
            <motion.li
              key={feature}
              variants={fadeInUp}
              className="flex items-start gap-3 text-sm sm:text-base text-[#1D1D1F]/80"
            >
              <ChevronRight className="w-4 h-4 sm:w-5 sm:h-5 text-[#86868B] mt-0.5 shrink-0" />
              <span>{feature}</span>
            </motion.li>
          ))}
        </motion.ul>
...
function PianoSection() {
  return (
    <AnimatedSection id="piano" className="py-24 sm:py-32 md:py-40 bg-[#FAFAFA]">
      <div className="max-w-[1200px] mx-auto px-6 sm:px-8">
        <CourseCard
...
function MentorCard({ name, role, bio, imageUrl }: MentorCardProps) {
  return (
    ...
    >
      ...
      <h3 className="text-lg sm:text-xl font-semibold text-[#1D1D1F] mb-1">
        {name}
      </h3>
      <p className="text-xs sm:text-sm text-[#86868B] font-medium mb-3 tracking-wide">
        {role}
      </p>
...
function MentorsSection() {
  ...
  return (
    <AnimatedSection id="mentors" className="py-24 sm:py-32 md:py-40 bg-[#FAFAFA]">
      <div className="max-w-[1200px] mx-auto px-6 sm:px-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-5 sm:space-y-6">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 sm:gap-6">
              <div>
                ...
                <input
                  ...
                  placeholder="您的称呼"
                  className="w-full px-4 py-3.5 rounded-xl bg-[#F5F5F7] border-0 text-[#1D1D1F] placeholder:text-[#86868B]/60 text-sm focus:outline-none focus:ring-2 focus:ring-[#1D1D1F]/20 transition-all"
                />
              </div>
              <div>
                <label className="block text-xs font-medium text-[#86868B] mb-2 uppercase tracking-wider">
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full px-4 py-3.5 rounded-xl bg-[#F5F5F7] border-0 text-[#1D1D1F] placeholder:text-[#86868B]/60 text-sm focus:outline-none focus:ring-2 focus:ring-[#1D1D1F]/20 transition-all resize-none"
              />
            </div>
            ...
            <motion.button
              ...
              type="submit"
              disabled={loading}
              className="w-full py-4 rounded-xl bg-[#1D1D1F] text-white text-sm font-semibold tracking-wide hover:bg-[#333] transition-colors flex items-center justify-center gap-2 disabled:opacity-60"
            >
...
function ContactBar() {
  return (
    <AnimatedSection className="py-16 sm:py-20 bg-[#1D1D1F]">
      <div className="max-w-[1200px] mx-auto px-6 sm:px-8">
        <motion.div
          variants={staggerContainer}
          initial="hidden"
...
function Footer() {
  return (
    <footer className="py-8 sm:py-10 bg-[#1D1D1F] border-t border-white/10">
      <div className="max-w-[1200px] mx-auto px-6 sm:px-8">
...
export default function HomePage() {
  return (
    <div className="min-h-screen bg-white font-sans antialiased selection:bg-[#1D1D1F] selection:text-white">
